...
\hspace{0.60cm}Aplikacja mobilna będzie pełnić funkcje aplikacji która będzie skierowana do osób które uprawiają sporty biegowe. Aplikacja będzie monitorowała takie parametry jak: przebyty dystans, liczba kroków, obecną lokalizacje, liczbe spalonych kalorii. Dodatkowo aplikacja będzie przechowywała historie aktywności, będzie można ustawić cele na przyszłość oraz dla lepszego komfortu użytkownika automatyczna regulacja jasności ekranu. . 
